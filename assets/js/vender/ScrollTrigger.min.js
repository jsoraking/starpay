  ...
  return function (t, e, n) {
    ...
    var o = function (t, e) {
      ...
      this.left = function (t) {
        ...
        return function () {
          var e = t.defaultOptions, l = t.element.getAttribute("data-scroll");
          ...
          var s = l.indexOf("addWidth") > -1, o = l.indexOf("addHeight") > -1, r = l.indexOf("once") > -1;
    ...
    return this.scrollDidChange = function (t) {
      return function () {
        var e = t.scrollElement.innerWidth || t.scrollElement.offsetWidth,
          ...
          s = t.bindElement.scrollLeft ? t.bindElement.scrollLeft : document.documentElement.scrollLeft, o = [];
        r.each(function (t) {
          var r = t.left(), c = t.top();
